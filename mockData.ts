...
export const MOCK_REQUESTS: TravelRequest[] = [
  { id: 'r1', type: 'Flight', status: 'Confirmed', details: 'Outbound: LHR to FNJ - BA234 (Confirmed)', date: 'June 12, 2026' },
  { id: 'r2', type: 'Hotel', status: 'Approved', details: 'Pyongyang Hotel - Presidential Suite (Final Approval)', date: 'June 12-20, 2026' },
